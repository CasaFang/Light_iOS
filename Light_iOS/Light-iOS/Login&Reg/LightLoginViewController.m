...
-(UIButton *)registerButton{
    if(_registerButton == nil){
        ...
        _registerButton= [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(self.usernameField.frame)+CGRectGetWidth(self.usernameField.frame)/4, CGRectGetHeight(self.view.frame)-TextFieldHeight, CGRectGetWidth(self.usernameField.frame)/2, TextFieldHeight)];
