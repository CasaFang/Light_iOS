...
#import "LightIntroView.h"
#import "AppDelegate.h"

@interface LightIntroViewController ()

@end

@implementation LightIntroViewController
...
/*
    ...
    LightIntroPage *page2 = [LightIntroPage page];
    page2.title = @"This is page 2";
    page2.desc = @"咖啡豆.";
    page2.bgImage = [UIImage imageNamed:@"2"];
    page2.titleImage = [UIImage imageNamed:@"supportcat"];
    
    LightIntroPage *page3 = [LightIntroPage page];
    ...
    LightIntroView *intro = [[LightIntroView alloc] initWithFrame:self.view.bounds andPages:@[page1,page2,page3]];
*/
    NSLog(@"开始");
    LightIntroPage *page1 = [LightIntroPage page];
    page1.bgImage = [UIImage imageNamed:@"Intro01"];
    
    LightIntroPage *page2 = [LightIntroPage page];
    page2.bgImage = [UIImage imageNamed:@"Intro02"];
    
    LightIntroPage *page3 = [LightIntroPage page];
    page3.bgImage = [UIImage imageNamed:@"Intro03"];
    
    LightIntroPage *page4 = [LightIntroPage page];
    page4.bgImage = [UIImage imageNamed:@"Intro04"];

    LightIntroPage *page5 = [LightIntroPage page];
    page5.bgImage = [UIImage imageNamed:@"Intro05"];

    LightIntroView *intro = [[LightIntroView alloc]initWithFrame:self.view.bounds andPages:@[page1,page2,page3,page4,page5]];
    NSLog(@"显示界面");
...
- (void)showIntroWithCustomView {
    ...
    LightIntroPage *page2 = [LightIntroPage pageWithCustomView:viewForPage2];
...
- (void)showIntroWithSeparatePagesInit {
    LightIntroView *intro = [[LightIntroView alloc] initWithFrame:self.view.bounds];
