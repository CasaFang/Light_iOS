...
- (UIView *)viewForPage:(LightIntroPage *)page atXIndex:(CGFloat *)xIndex {
...
- (UIImage *)bgForPage:(int)idx {
    ...
    return ((LightIntroPage *)_pages[idx]).bgImage;
}
